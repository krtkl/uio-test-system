...
set rc [catch {
  ...
  set_property webtalk.parent_dir Z:/Software/uio-test-system/uio-test-system.cache/wt [current_project]
  ...
  catch {file copy -force debug_nets.ltx base_wrapper.ltx}
